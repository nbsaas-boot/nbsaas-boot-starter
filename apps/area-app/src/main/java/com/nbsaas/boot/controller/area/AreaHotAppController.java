...
@RestController
@RequestMapping("/app/areaHot")
public class AreaHotAppController {
    ...
    */
    ...
    public ResponseObject<AreaHotResponse> create(@Validated(AddOperator.class) AreaHotDataRequest request) {
     ...
     public ResponseObject<AreaHotResponse> update(@Validated(UpdateOperator.class) AreaHotDataRequest
         request) {
