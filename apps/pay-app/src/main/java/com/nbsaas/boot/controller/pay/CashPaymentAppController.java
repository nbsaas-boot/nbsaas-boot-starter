...
@RestController
@RequestMapping("/app/cashPayment")
public class CashPaymentAppController {
    ...
    */
    ...
    public ResponseObject<CashPaymentResponse> create(@Validated(AddOperator.class) CashPaymentDataRequest request) {
     ...
     public ResponseObject<CashPaymentResponse> update(@Validated(UpdateOperator.class) CashPaymentDataRequest
         request) {
