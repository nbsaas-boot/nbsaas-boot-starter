...
@RestController
@RequestMapping("/app/applicationMenu")
public class ApplicationMenuAppController {
    ...
    public ResponseObject<ApplicationMenuResponse> update(@Validated(UpdateOperator.class) ApplicationMenuDataRequest
                                                                  request) {
